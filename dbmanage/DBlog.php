				  ...
				  $query = "INSERT INTO tbl_tratamientos(id_cita,id_usuario, id_estatus_tratamiento, notas) ";
					...
					$idtratamiento = $row['id_tratamiento'];
							...
							if($_POST['med1'] != '')
							{
								...
								/*
$query = "INSERT INTO `cl45-synertst69`.`tbl_detalles_tratamiento` (`id_tratamiento`, `partida`, `medicamento`, `tipo`, `cantidad`, `hora`, `tx_inicio`, `tx_fin`, `id_estatus_tratamiento`)
